...
- **17 comandos → 3.** /plan absorve brainstorm+plan+roadmap+audit e as perguntas de
  stack/design/setup. /go absorve next+coding+ship+loop+ops. /fix é port quase literal —
...
### Invertido
- **Autonomia agora é o default.** `/go 1..N` roda sem devolver o turno: push da branch,
...
- **Autocommit hook e loop.sh** — commit é ato do loop, não efeito colateral; headless é go.ps1.

*/plan desenha o mapa. /go dirige até o fim. /fix quando quebra.*
